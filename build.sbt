...
libraryDependencies += "org.apache.zookeeper" % "zookeeper" % "3.4.6.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hbase" % "hbase-client" % "1.1.2.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hbase" % "hbase-common" % "1.1.2.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hbase" % "hbase-protocol" % "1.1.2.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hbase" % "hbase-server" % "1.1.2.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hadoop" % "hadoop-client" % "2.7.3.2.6.1.0-129" % "provided"
libraryDependencies += "org.apache.hadoop" % "hadoop-common" % "2.7.3.2.6.1.0-129" % "provided"
